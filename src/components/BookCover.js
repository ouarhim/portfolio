...
// Dynamically import all images and videos from src/bookcover
const mediaContext = require.context('../bookcover', false, /\.(png|jpe?g|gif|mp4|webm)$/);
...
const BookCover = () => {
  ...
  return (
    <section id="book-cover" className="py-20 bg-black text-white relative overflow-x-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-1/4 top-1/3 w-[16vw] h-[16vw] bg-gradient-to-r from-red-500 to-pink-500 rounded-full filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-[16vw] h-[16vw] bg-gradient-to-r from-pink-500 to-blue-500 rounded-full filter blur-3xl opacity-20 animate-blob animation-delay-3000"></div>
      </div>
      <motion.div 
      ...
      >
        <h2 className="text-4xl font-title font-bold mb-8 text-center">Cover Design</h2>
