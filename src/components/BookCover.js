...
const BookCover = () => {
  ...
  return (
    <>
      ...
      {/* Desktop View */}
      <section id="book-cover" className="hidden sm:block py-20 bg-black text-white relative overflow-x-hidden">
        ...
        >
          <h2 className="text-8xl font-title font-bold mb-20 text-center">Cover Design</h2>
