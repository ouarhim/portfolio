...
const WebDesign = () => {
  ...
  return (
    <>
      {/* Mobile View */}
      <div id="mobile-web-design" className="sm:hidden">
        <MobileMediaGallery
      ...
      {/* Desktop View */}
      <section id="web-design" className="hidden sm:block py-20 bg-black text-white relative overflow-x-hidden">
        ...
        >
          <h2 className="text-8xl font-title font-bold mb-20 text-center">Web Design</h2>
