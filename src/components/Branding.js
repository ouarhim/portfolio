...
const Branding = () => {
  ...
  return (
    <>
      ...
      {/* Desktop View */}
      <section id="branding" className="hidden sm:block py-20 bg-black text-white relative overflow-x-hidden">
        ...
        >
          <h2 className="text-8xl font-title font-bold mb-20 text-center">Branding</h2>
