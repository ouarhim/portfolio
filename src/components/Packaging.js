...
// Dynamically import all images and videos from src/packaging
...
const Packaging = () => {
  ...
  return (
    <>
      ...
      {/* Desktop View */}
      <section id="packaging" className="hidden sm:block py-20 bg-black text-white relative overflow-x-hidden">
        ...
        >
          <h2 className="text-8xl font-title font-bold mb-20 text-center">Packaging</h2>
